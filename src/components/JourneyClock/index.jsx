  ...
  return (
    <div className='journeyClock__container fadeIn'>
          ...
          {emptyLinesArray.map((_, i) => {
            return (
              <div
                ...
                style={{
                  transform: `rotate(${(i * 30)}deg) translateY(var(--line-distance))`
                }}
              />
            )
          })}
      ...
      <p className='journeyClock__textB'>
        Aún queda mucho tiempo por delante, muchas horas para decidir qué hacer con lo que te queda de este día…y es sola una pequeña fracción de lo que hay por delante.<span style={{ fontWeight: 600 }}> Los mejores deseos {userData.name} !</span>
      </p>
    </div>
  )
}
